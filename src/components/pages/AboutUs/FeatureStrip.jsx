export function FeatureStrip() {
  const items = [
    { icon: "fa-solid fa-map-location-dot", text: "Complete Packages For All Your Wishes" },
    { icon: "fa-solid fa-award", text: "Over 30 Years Of Experience" },
    { icon: "fa-solid fa-user-tie", text: "Expert Guides For You" },
    { icon: "fa-solid fa-hand-holding-dollar", text: "Guaranteed fun at the best price!" },
  ];

  return (
    <section className="relative w-full">
      <div className="bg-gradient-to-r from-[#FFD0A6] via-[#FFBF8F] to-[#FFB07A]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-16 py-10 sm:py-12">
  ...
  return (
    <div
      className="rounded-2xl bg-white/55 backdrop-blur-sm border border-white/60
                 ...
                 px-6 py-7 sm:py-8 flex flex-col items-center text-center
