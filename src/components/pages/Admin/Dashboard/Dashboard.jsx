    ...
    <div className="max-w-6xl mx-auto py-10">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Overview admin (mock UI)</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="lg:col-span-2">
          <Panel
            ...
            right={
              <Link to="/admin/tours">
                <button className="border border-orange-500 text-orange-500 px-4 py-1.5 rounded-full hover:bg-orange-500 hover:text-white transition text-sm font-semibold">
                  View Tours
                </button>
              </Link>
            }
          >
            <div className="space-y-4">
              {revenue.map((r) => (
                <div key={r.m} className="grid grid-cols-12 gap-3 items-center">
          ...
          <div className="space-y-4">
            {recentNotis.map((n) => (
              <div key={n.id} className="border border-gray-100 rounded-xl p-4">
                ...
                <div className="mt-3 text-sm text-gray-800">{n.message}</div>
              </div>
            ))}
          </div>
        </Panel>
      ...
      <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link to="/admin/tours">
              <button className="border border-orange-500 text-orange-500 px-5 py-2 rounded-full font-semibold hover:bg-orange-500 hover:text-white transition">
                Tours
              </button>
            </Link>
            <Link to="/admin/users">
