...
export const vi = {
  ...
  tourPage: {
    ...
    nearestStart: "Ngày khởi hành gần nhất",
    biggestDiscount: "Giảm giá nhiều nhất",
    lowToHigh: "Thấp → Cao",
    highToLow: "Cao → Thấp",
    noToursFound: "Không tìm thấy tour phù hợp",
    tryChanging: "Thử đổi ngày khởi hành, điểm đi, điểm đến hoặc số ngày để tìm thêm tour.",
    loading: "Đang tải tour...",
    clearDuration: "Xóa thời gian",
    dayStart: "Ngày đi",
    dayEnd: "Ngày về",
    dayPlaceholder: "dd/mm/yyyy",
    tipClickDate: "Click 1 ngày để chọn Ngày đi, click lần 2 để chọn Ngày về.",
    seats: "Ghế còn lại:",
    adult: "Người lớn",
    child: "Trẻ em",
    selectAtLeast: "Vui lòng chọn ít nhất 1 vé.",
    back: "Quay lại",
    continue: "Tiếp tục",
    viewParticipants: "Xem danh sách",
    prev: "‹ Trước",
    next: "Tiếp ›",
    noData: "Đang cập nhật",
    notAvailable: "Không có sẵn",
    noDescriptionAvailable: "Không có mô tả cho tour này.",
    selectDate: "Chọn một ngày",
    chooseTravelDate: "Chọn ngày du lịch",
  },
  ...
  blogPage: {
    ...
    readMore: "Đọc thêm",
    filteredByTag: "Đã lọc theo thẻ:",
    clearTag: "Xóa thẻ",
    invalidDate: "Ngày không hợp lệ. Nhập đúng dd/mm/yyyy.",
    admin: "Admin",
  },
};
